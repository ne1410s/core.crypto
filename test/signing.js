...
describe('#signing', () => {
    ...
    it('should create a pkcs12 file', async () => {
        const name = 'Test Cert!',
              ...
              password = 'abcDEF123!',
              sut = await ne14.Crypto.pfx(name, cert_b64, key_b64, password);
